...
class Carpet extends WorldObject {
  ...
  defineGeometry() {
    ...
    this.carpetSurface = new OBJ0.RectSurface3D(p1, p2, p3, p4, {
      divCount1: 20,
      divCount2: 4,
      color: TrackColor
    });
    this.sideSurface1 = new OBJ0.RectSurface3D(p4, baseP4, baseP1, p1, {
      divCount1: 20,
      divCount2: 1,
      color: DiscColor
    });
    this.sideSurface2 = new OBJ0.RectSurface3D(p2, baseP2, baseP3, p3, {
      divCount1: 20,
      divCount2: 1,
      color: DiscColor
    });
